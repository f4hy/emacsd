...
(setq save-place-file "~/.emacs.d/history/saveplace")
...
(setq savehist-additional-variables    ;; also save...
      ...
      savehist-file (concat "~/.emacs.d/history" "/savehist"))   ;; keep my home clean
(savehist-mode t)                      ;; do customization before activation

;; save recent files
(setq recentf-save-file (concat dotfiles-dir "history/recentf") ;; keep ~/ clean
